...
public class AverageEducationFemaleDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		if(args.length != 2) {
			...
			job.setJarByClass(AverageEducationFemaleDriver.class);
			...
			job.setMapperClass(AverageEduFemaleMapper.class);
			job.setReducerClass(AverageEduFemaleReducer.class);
