...
public class IntersectionTest {
	...
	public void testReducer(){
		...
		reduceDriver.withInput(new Text("Egypt, Arab Rep."), values);
		reduceDriver.withOutput(new Text("Egypt, Arab Rep."),new Text(""));
	...
	public void testMapReduce(){
		...
		mapReduceDriver.withInput(new LongWritable(1), new Text("\"Egypt, Arab Rep.\",\"EGY\",\"Legislation explicitly criminalizes marital rape (1=yes; 0=no)\",\"SG.LEG.MRRP\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"0\",\"\","));
		mapReduceDriver.withInput(new LongWritable(1), new Text("\"Egypt, Arab Rep.\",\"EGY\",\"Married women are required by law to obey their husbands (1=yes; 0=no)\",\"SG.LAW.OBHB.MR\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"1\",\"\",\"1\",\"\",\"1\",\"\",\"1\",\"\","));
		...
		mapReduceDriver.withOutput(new Text("Egypt, Arab Rep."),new Text(""));
